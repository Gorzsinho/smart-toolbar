...
module.exports = (async () => {
    ...
    try {
        ...
        await load(container, import('smart-toolbar/lib/browser/smart-toolbar-frontend-module'));
        await load(container, import('target-operation-panel/lib/browser/target-operation-panel-frontend-module'));
